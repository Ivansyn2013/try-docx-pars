...
for ii, i in enumerate(oks_doc12.paragraphs):
    if RE_LINESTART.search(i.text) :
        quest.append(i.text)
        #print(i.text)
    elif re.search(r'^А\.', i.text):
        ans_A.append(i.text)
        #print(i.text)
    elif re.search(r'^Б\.', i.text):
        ans_B.append(i.text)
        #print(i.text)
    elif re.search(r'^В\.', i.text):
        ans_V.append(i.text)
        #print(i.text)
    elif re.search(r'^Г\.', i.text):
        ans_G.append(i.text)
        #print(i.text)
    elif re.search(r'^Д\.', i.text):
        ans_D.append(i.text)
